...
import { formatDate, isFutureDate } from "/cdn/utils/time/date.js";
import { safeExecuteAsync, createError, ErrorTypes } from "/cdn/utils/core/error.js";
import { categorizeNewsItem } from "/cdn/utils/data/domain.js";
...
export const createStore = () => {
  ...
  /**
   * 设置顶部分类
   * @param {('all'|'dailyChecklist'|'news'|'projectFiles')} key
   */
