            ...
            <div class="calendar-view">
                <div class="calendar-header">
                    ...
                    <div class="calendar-controls">
                        <button type="button" class="calendar-nav-btn" @click="previousMonth" title="上个月">
                            <i class="fas fa-chevron-left"></i>
                        </button>
                        <div class="calendar-current-month">{{ currentMonthYear }}</div>
                        <button type="button" class="calendar-nav-btn" @click="nextMonth" title="下个月">
                            <i class="fas fa-chevron-right"></i>
                        </button>
                        <button type="button" class="calendar-nav-btn today-btn" @click="goToToday" title="回到今天">
                ...
                <div v-if="selectedTask" class="task-detail-modal" @click="closeTaskDetail">
                    <div class="task-detail-content" @click.stop>
                        <div class="task-detail-header">
                            ...
                            <button type="button" class="close-btn" @click="closeTaskDetail" aria-label="关闭" title="关闭">
                        ...
                        <div class="task-detail-actions">
                            <button type="button" @click="editTask(selectedTask)" class="action-btn edit">
                                <i class="fas fa-edit"></i>
                                编辑
                            </button>
                            <button type="button" @click="deleteTask(selectedTask)" class="action-btn delete">
