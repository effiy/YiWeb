...
> | v3.0.1 | 2026-05-27 | deepseek-v4-pro | 🌿 feat/aicr | 📎 [CLAUDE.md](../../../CLAUDE.md) |
...
| 接口 | 方法 | 服务模块 | 用途 | 场景 |
|------|------|---------|------|:--:|
| `query_documents` | GET/POST | `data_service` | 查询会话/文档列表 | 1, 4, 5 |
| `create_document` | POST | `data_service` | 创建会话/文档记录 | 4, 5 |
| `update_document` | POST | `data_service` | 更新会话元数据/标签/消息 | 4 |
| `delete_document` | POST | `data_service` | 删除会话/文档记录 | 4, 5 |
| `chat` | POST (SSE) | `ai.chat_service` | AI 对话，流式 SSE 响应 | 2 |
| `list_ollama_models` | GET | `ai.chat_service` | 获取可用 AI 模型列表 | 2 |
| `/read-file` | POST | — | 读取文件内容（文本/图片） | 1, 5 |
| `/write-file` | POST | — | 创建或覆盖写入文件 | 5 |
| `/delete-file` | POST | — | 删除单个文件 | 5 |
| `/delete-folder` | POST | — | 递归删除文件夹 | 5 |
| `/rename-file` | POST | — | 重命名文件 | 5 |
| `/rename-folder` | POST | — | 重命名文件夹 | 5 |
| `/upload/upload-image-to-oss` | POST | — | 上传 base64 图片到阿里云 OSS | 2 |
| `/wework/send-message` | POST | — | 发送企业微信群机器人消息 | 2 |
