...
> | v1.0.1 | 2026-05-26 | deepseek-v4-pro | 📎 [CLAUDE.md](../../../CLAUDE.md) |

> **导航**: [← 使用场景](./使用场景.md) · [安全审计 →](./安全审计.md)
>
...
- ⚡ 三级联动筛选 — 基于 computed 响应式缓存的高性能过滤
...
Level 3: 状态标签  → 在 L1+L2 范围内，按文档类型文件夹过滤

联动规则:
- L1 选择 → L2/L3 统计基于 L1 范围重新计算
- L2 选择 → L3 统计基于 L1+L2 范围重新计算
- Escape 清除 → 全部重置为空
```
