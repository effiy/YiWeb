...
> **父故事**: [← yiweb-arch](../yiweb-arch/故事任务.md) · **导航**: [→ 场景1-查下游.md](./场景1-查下游.md)
...
| 3 | 新增组件或模块时模块地图可能过时 | 风险 | M | L | 父故事 yiweb-arch 变更时触发增量刷新 | FP2.1–2.5 |
| 4 | CDN 组件确实不依赖 src 模块 | 假设 | — | — | 源码结构反映依赖方向约束 | FP2.7 |
| 5 | ≥ 20 个模块覆盖可满足当前所有使用场景需求 | 假设 | — | — | 覆盖全部通用组件 + 渲染插件 + 基础设施 + 服务层即达标 | 全部 |

---

> **变更记录**：v1.0.0 — 从父故事 yiweb-arch FP2 拆分创建（2026-05-28，`/rui doc`）
